<footer class="bg-dark" id="tempaltemo_footer">
        <div class="container">
            <div class="row">
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li>
                            ...
                            <a class="text-decoration-none" href="tel:0123456789">0123456789</a>
                        </li>
                        <li>
                            <i class="fa fa-envelope fa-fw"></i>
                            <a class="text-decoration-none" href="mailto:info@company.com">abc@gmail.com</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li><a class="text-decoration-none" href="${base}/Contact_us">Contact</a></li>
                    </ul>
                </div>
            ...
            <div class="row text-light mb-4">
             ...
             <!-- Subcribe -->
             <jsp:include page="/WEB-INF/views/User/layout/subcribe.jsp"></jsp:include>
             <!-- /Subcribe -->
            </div>
        </div>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            Copyright &copy; 2021 -self 
                            | Designed by <a rel="sponsored" href="#" target="_blank">GonL</a>
                        </p>
                    </div>
                </div>
            </div>
